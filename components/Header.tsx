  ...
  return (
    <header>
      ...
      {pathname.startsWith("/admin") === false && (
        <div className="h-32 flex bg-white items-center justify-between px-16 max-[1320px]:px-16 max-md:px-6 max-lg:flex-col max-lg:gap-y-7 max-lg:justify-center max-lg:h-60 max-w-screen-2xl mx-auto">
          <Link href="/">
            <Image
              src="/logo-v1-svg.svg"
              width={300}
