      ...
      <div className="flex flex-col gap-y-7 xl:ml-5 max-xl:px-5 w-full">
        ...
        <div className="flex gap-x-2">
          <button
            onClick={addProduct}
            type="button"
            className="uppercase bg-green-500 px-10 py-5 text-lg borde border-gray-300 font-bold text-white shadow-sm hover:bg-green-600 hover:text-white focus:outline-none focus:ring-2"
          >
            Add product
          </button>
        </div>
